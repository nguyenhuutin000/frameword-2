    ...
    <>
      <ul className="nav nav-pills flex-column mb-auto" data-bs-themes>
        <li className="nav-item">
          <Link
            href="/admin"
            className={`nav-link rounded-0  ${pathname == "/admin" ? "active" : "text-white"}`}
            aria-current="page"
          >
        ...
        <li>
          <Link
            href="/admin/order"
            className={`nav-link rounded-0  ${pathname == "/admin/order" ? "active" : "text-white"}`}
          >
        ...
        <li>
          <Link
            href="/admin/product"
            className={`nav-link rounded-0  ${pathname == "/admin/product" ? "active" : "text-white"}`}
          >
        ...
        <li>
          <Link
            href="/admin/category"
            className={`nav-link rounded-0  ${pathname == "/admin/customer" ? "active" : "text-white"}`}
          >
        ...
        <li>
          <Link
            href="/admin/rating"
            className={`nav-link rounded-0  ${pathname == "/admin/rating" ? "active" : "text-white"}`}
          >
